...
print('Accuracy percentage on Validation Image Data: ',accuracy*100,'%')
...
print('Accuracy percentage on Test Image Data: ',acc*100,'%')
...
plt.title('ROC Curve of using KNN model')
plt.legend()
plt.show()